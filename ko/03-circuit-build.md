...
DC-DC 모듈이나 커넥터, 배선 같은 부품들은 회로도에서 볼 때는 별로 공간을 차지하지 않아 보였는데, 실제로 한곳에 모아놓으니 생각보다 빠르게 공간이 부족해졌다.
...
[← 02. 브레드보드 회로 테스트](02-prototype.html) · [제작기 목록](index.html) · [04. 케이스와 자전거 설치 →](04-enclosure.html)

🌐 [English version](../en/03-circuit-build.html)
